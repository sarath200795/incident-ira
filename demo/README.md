# Tutorial video harness — incident-ira

Regenerates the screen-recorded tutorial (`incident-ira.mp4`) by driving the **real app**
...
```
The video is written to `demo/out/incident-ira.mp4`.
